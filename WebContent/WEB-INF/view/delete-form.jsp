      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="go-to-logination">Login</a></li>
            <c:choose>
...
<!--             </li> -->
	...
	<div class="container" style="margin: 200px 0 200px 0;">
        ...
        <div class="container"><p>If you wont to delete user enter e-mail and password:</p></div>
        <form action="delete-manager" method="post">  
			...
			<input class="btn btn-info btn-sm" type="submit" />   <a href="manager-form" class="btn btn-default btn-sm">На Главную</a> 
		</form>
		<i style="color: red">
